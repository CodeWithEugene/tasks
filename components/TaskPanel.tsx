...
const TaskPanel: React.FC<TaskPanelProps> = ({ tasks, onAddTask, onUpdateTask, onDeleteTask, onToggleComplete }) => {
            ...
            <div className="space-y-4">
                ...
                <form onSubmit={handleRegularAdd} className="hidden sm:flex items-center gap-2">
                    <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D48A8A]"
                    />
                    <input
                        type="text"
                        value={description}
                        ...
                        className="w-full hidden md:block px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D48A8A]"
                    />
                ...
                <div className="flex items-center gap-2">
                 ...
                 <div className="relative w-full sm:w-auto">
                    <input
                        ...
                        className="w-full sm:w-auto pl-4 pr-10 py-1.5 border border-gray-300 rounded-lg text-sm focus:outline-none"
                    />
